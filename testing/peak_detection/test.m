...
data = load('data\mimic_raw\AF\438\00010\43800010m.mat');
...
% low_cutoff = lowest_component;  % Adjust this value based on the lowest relevant ECG frequency
% high_cutoff = 10;  % Adjust this value based on the highest relevant ECG frequency
% 
% Wn = [low_cutoff, high_cutoff] / nyquist;
% [b, a] = butter(order, Wn, 'bandpass');
% 
% % Apply the band-pass filter to the ECG signal
...
% % Plot PPG with ECG PQRST points
% figure;
% plot(time_vector, PPG_signal);
% hold on;
% 
% % Plot R peaks
% scatter(time_vector(R_loc), ECG_signal(R_loc), 'yo', 'filled', 'DisplayName', 'R Peaks');
